						...
						<ul className="menu-links">
							<li className="nav-link">
								<Link to="/" className="sidebar-link">
									...
									<span className="tooltip">{t("Home-sidebar")}</span>
								</Link>
							</li>
							...
							<li className="nav-link">
								<Link to="/usuarios" className="sidebar-link">
									...
									<span className="tooltip">{t("Users-sidebar")}</span>
								</Link>
							</li>
							<li className="nav-link">
								<Link to="/Produtos" className="sidebar-link">
									...
									<span className="tooltip">{t("Products-sidebar")}</span>
								</Link>
							</li>
							...
							<li className="nav-link">
								<Link to="/analytics" className="sidebar-link">
									...
									<span className="tooltip">{t("Analytics-sidebar")}</span>
								</Link>
							</li>
							<li className="nav-link">
								<Link to="/notificacoes" className="sidebar-link">
									...
									<span className="tooltip">{t("Notifications-sidebar")}</span>
								</Link>
							</li>
							<li className="nav-link">
								<Link to="/Pedidos" className="sidebar-link">
									...
									<span className="tooltip">{t("Orders-sidebar")}</span>
								</Link>
							</li>
							<li className="nav-link">
								<Link to="/calendario" className="sidebar-link">
									...
									<span className="tooltip">{t("Calendar-sidebar")}</span>
								</Link>
							</li>
							<li className="nav-link">
								<Link to="/receita" className="sidebar-link">
									...
									<span className="text nav-text">{t("Revenue-sidebar")}</span>
									<span className="tooltip">{t("Revenue-sidebar")}</span>
								</Link>
							</li>
						</ul>
					</div>
